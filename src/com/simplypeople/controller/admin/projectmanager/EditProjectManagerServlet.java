...
@WebServlet("/admin/edit_manager")
public class EditProjectManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public EditProjectManagerServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		projectmanagerServices.editProjectmanager();
	}
