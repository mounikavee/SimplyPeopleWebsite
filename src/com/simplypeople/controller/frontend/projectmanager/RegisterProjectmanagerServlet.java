...
@WebServlet("/register_projectmanager")
public class RegisterProjectmanagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public RegisterProjectmanagerServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		projectmanagerServices.registerProjectmanager();
